...
const int poten = A0; // donar nom al pin A0 de l’Arduino
int velocitat = 20; // velocitat de l'acció en ms
int valorPot0; // guardar valor del poyenciometre
...
void loop()
{
valorPot0 = analogRead(poten); // llegir valor del potenciòmetre
velocitat = valorPot0; // actualitzar velocitat amb el valor del potenciòmetre
